...
export const interceptUnauthenticatedCollections = (body, headers, additionalRequests = []) => {
  ...
  (req) => {
    ...
    if (req.body === 'has_granules_or_cwic=true&include_facets=v2&include_granule_counts=true&include_has_granules=true&include_tags=edsc.%2A%2Copensearch.granule.osdd&page_num=1&page_size=20&sort_key%5B%5D=has_granules_or_cwic&sort_key%5B%5D=-usage_score') {
